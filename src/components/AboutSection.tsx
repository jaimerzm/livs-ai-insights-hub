        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <div className="bg-livs-gray-light px-4 py-2 rounded-full text-livs-blue">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {team.map((member, index) => (
              <div 
                key={index} 
                className="bg-livs-gray-light border border-livs-gray rounded-xl p-6 hover:shadow-lg transition-shadow duration-300"
              >
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-1 text-livs-blue hover:text-livs-purple"
                  target="_blank"
