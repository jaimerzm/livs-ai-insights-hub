...
const ServicesSection = () => {
  ...
  const packs = [{
    ...
    features: ["Implementación inicial completa", "Mantenimiento mensual de todos los sistemas", "Actualizaciones y mejoras periódicas", "Soporte técnico prioritario", "Formación personalizada del equipo"],
    highlighted: true
  }];
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <div className="text-livs-gray-dark text-lg mb-8">
            <p className="mb-6">​<strong className="text-xl text-livs-blue block mb-3">Soluciones de IA Personalizadas para Tu Empresa</strong>
            ...
            <div className="mt-8 mb-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-left">
                  Estaremos en constante contacto contigo mientras tengas uno de nuestros servicios implementado en tu negocio. 
 Puede cancelar en cualquier momento, total transparencia.       
        ...
        <div className="mb-16">
          ...
          <div className="max-w-2xl mx-auto">
            {packs.map((pack, index) => <Card key={index} className="border-livs-purple border-2 bg-white hover:shadow-xl transition-shadow duration-300 relative overflow-hidden">
                ...
                <CardContent>
                  ...
                  <div className="mt-6">
                    ...
                    <ul className="space-y-2">
                      {pack.features.map((feature, idx) => <li key={idx} className="flex items-start">
