      ...
      <main className="flex-grow container mx-auto px-4 pt-24 pb-12">
        <div className="max-w-4xl mx-auto border border-gray-700 rounded-lg p-6 shadow-lg bg-gradient-to-br from-gray-900 to-black">
          <div className="prose prose-invert prose-sm">
            ...
            <h2 className="text-lg font-semibold mt-8 mb-4 text-white">Datos identificativos del titular</h2>
            ...
            <h2 className="text-lg font-semibold mt-8 mb-4 text-white">Objeto</h2>
            <p className="text-sm">
            ...
            <h2 className="text-lg font-semibold mt-8 mb-4 text-white">Condiciones de uso</h2>
            <p className="text-sm">
            ...
            <h2 className="text-lg font-semibold mt-8 mb-4 text-white">Responsabilidad</h2>
            <p className="text-sm">
              LIVS no se hace responsable de los daños y perjuicios de cualquier naturaleza que pudieran ocasionar, a título enunciativo: errores u omisiones en los contenidos, falta de disponibilidad del portal o la transmisión de virus o programas maliciosos o lesivos en los contenidos, a pesar de haber adoptado todas las medidas tecnológicas necesarias para evitarlo.
            </p>

            <h2 className="text-lg font-semibold mt-8 mb-4 text-white">Protección de datos personales</h2>
            <p className="text-sm">
            ...
            <h2 className="text-lg font-semibold mt-8 mb-4 text-white">Enlaces a terceros</h2>
            <p className="text-sm">
            ...
            <h2 className="text-lg font-semibold mt-8 mb-4 text-white">Modificaciones</h2>
            <p className="text-sm">
            ...
            <h2 className="text-lg font-semibold mt-8 mb-4 text-white">Legislación aplicable y jurisdicción</h2>
            <p className="text-sm">
