      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-slate dark:prose-invert">
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-livs-blue">Datos identificativos del titular</h2>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-livs-blue">Objeto</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-livs-blue">Condiciones de uso</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-livs-blue">Propiedad intelectual e industrial</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-livs-blue">Responsabilidad</h2>
            <p>
              LIVS no se hace responsable de los daños y perjuicios de cualquier naturaleza que pudieran ocasionar, a título enunciativo: errores u omisiones en los contenidos, falta de disponibilidad del portal o la transmisión de virus o programas maliciosos o lesivos en los contenidos, a pesar de haber adoptado todas las medidas tecnológicas necesarias para evitarlo.
            </p>

            <h2 className="text-xl font-semibold mt-8 mb-4 text-livs-blue">Protección de datos personales</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-livs-blue">Enlaces a terceros</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-livs-blue">Modificaciones</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-livs-blue">Legislación aplicable y jurisdicción</h2>
            <p>
