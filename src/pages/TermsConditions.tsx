      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-invert">
            <h1 className="text-3xl font-bold mb-6 text-white">Términos y Condiciones de LIVS</h1>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-white">1. Terminología</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-white">2. Licencia</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-white">3. Exención de responsabilidad</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-white">4. Limitaciones</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-white">5. Modificaciones</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-8 mb-4 text-white">6. Legislación aplicable</h2>
            <p>
